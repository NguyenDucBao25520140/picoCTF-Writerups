...
- **Dấu hiệu:** Cên thử thách "Timeline 0" cùng tag "Forensics" gợi ý rõ ràng về việc cần phải trích xuất và phân tích dòng thời gian (timeline) sự kiện của hệ thống tập tin. Dữ liệu làm việc thực tế trên terminal là một file image của phân vùng (có tên là partition4.img).
...
- **Ý tưởng:** 
    ...
    - Qua phân tích (giả định tìm được dấu vết bất thường), xác định được file tình nghi nằm tại inode 4945.
...
kali@kali:~$ icat partition4.img 4945 > flag
